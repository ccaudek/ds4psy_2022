...
Nella seguente discussione useremo l'interfaccia `cmdstanr` di CmdStan.^[I modelli discussi in questo capitolo sono discussi da @gelman1995bayesian mentre il codice è stato ricavato dalla seguente [pagina web](http://avehtari.github.io/BDA_R_demos/demos_rstan/rstan_demo.html).]. Carichiamo i pacchetti necessari:
...
Il *modello* è $\Bin(n, \theta)$ e, in linguaggio Stan, può essere specificato come 
