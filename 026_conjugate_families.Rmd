...
È facile replicare il grafico precedente scrivendo noi stessi una funzione, come descritto in Appendice \@ref(appendix:beta-binom). Con la funzione `plot_beta_binom()` e i dati usati in precedenza otteniamo
