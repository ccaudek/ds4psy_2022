...
{\centering \includegraphics[width=0.45\linewidth]{ds4psy_files/figure-latex/unnamed-chunk-16-1} 
...
\includegraphics[width=0.5\textwidth,height=\textheight]{images/AperpBmidC.png}
...
\hypertarget{reti-bayesiane}{%
\section{Reti bayesiane}\label{reti-bayesiane}}
...
\includegraphics[width=0.3\textwidth,height=\textheight]{images/plates_example_1.png}
...
Per evitare una rappresentazione grafica disordinata è comune utilizzare una forma di zucchero sintattico (\emph{syntactic sugar}) chiamato \emph{``plates''} (piastre): si disegna un piccolo riquadro attorno alle variabili ripetute, con la convenzione che i nodi all'interno del riquadro vengano ripetuti il numero indicato di volte.

\includegraphics[width=0.3\textwidth,height=\textheight]{images/plates_example_2.png}
...
{\centering \includegraphics[width=1\linewidth]{ds4psy_files/figure-latex/unnamed-chunk-17-1} 
...
{\centering \includegraphics{ds4psy_files/figure-latex/unnamed-chunk-18-1} 
...
{\centering \includegraphics[width=1\linewidth]{ds4psy_files/figure-latex/unnamed-chunk-22-1} 
...
{\centering \includegraphics{ds4psy_files/figure-latex/unnamed-chunk-31-1} 
