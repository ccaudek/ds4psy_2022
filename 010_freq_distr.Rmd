...
# (PART) Analisi esplorativa dei dati {-}

# Variabili e distribuzioni di frequenza {#ch:freq-distr}
...
Per un esempio in una recente pubblicazione, possiamo considerare le figure 3 e 6 di @lazic2020determining.
:::
