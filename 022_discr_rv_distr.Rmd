...
Una distribuzione discreta uniforme è una distribuzione di probabilità discreta che è uniforme su un insieme, ovvero che attribuisce ad ogni elemento dell'insieme discreto $S$ su cui è definita la stessa probabilità $p$ di verificarsi (in particolare l'insieme dev'essere finito).

Consideriamo la variabile casuale $X$ con supporto $1, 2, \dots, m$. Un esperimento casuale in cui si verifica questa distribuzione è la scelta di un intero casuale compreso tra 1 e $m$ inclusi. Sia $X$ il numero scelto. Allora
