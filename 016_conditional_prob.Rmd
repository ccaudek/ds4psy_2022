...
mutualmente esclusivi ed esaustivi, ovvero ${\mbox{P}}(U_1 \cup U_2 \cup U_3) = 1.0$. In base al teorema della probabilità assoluta, la probabilità di estrarre una pallina rossa è dunque
